...
pkgs <- c("dplyr", "tidyr", "tibble", "stringr", "readr", "magrittr",
          ...
          "roxygen2", "testthat", "knitr", "rmarkdown", "bookdown")    
# Get the R reference
rref <- citation()
# Create ref key
rref$key <- "rversion"
