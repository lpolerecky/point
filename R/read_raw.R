...
#'
#' Ion count data consists of time-incremented integer values.
#' Currently only supported for data generated by a NanoSIMS50L.
#'
...
#'
#' read_IC(system.file("extdata", "2020-01-17-TREASURE", package = "point"))#'
#'
#' @export
...
# ions and MS setup
  ...
  f <- function(a, b, c) {
        ...
        read_table(paste0(directory, "/", a),
                   skip = b,
                   n_max = c,
                   col_names = c("num.mt", "species.mt", "mass.mt", "det.mt",
                                 "tc.mt (s)", "bfield.mt", "rad.mt", "X2",
                                 "X3", "X4"),
                   col_types = cols(
                                    num.mt = col_integer(),
