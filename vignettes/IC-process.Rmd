...
This causes the true EM Yield $Y_{EM}$ to be smaller than 100% (see Fig. `r fig$ref("PHD-curve")`). The PHD distribution adheres to the following principles:
...
$$X_{i}^{*} = \frac{X_i}{1- X_i  \times t_{ns} \times 10^9}$$  {#eq:Dead}
