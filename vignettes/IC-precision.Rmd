...
knitr::kable(head(tb.Xt),
             format.args = list(digits = 3, 
                                format = "G", 
                                flag = "0"),
             caption = "Table 1: Summary statistics for internal precision of single ions with stat_Xt.") 
```
...
knitr::kable(head(tb.R),
             format.args = list(digits = 3, 
                                format = "G", 
                                flag = "0"),
              caption = "Table 2: Summary statistics for internal precision of isotope ratios with stat_R.") 
```
...
knitr::kable(head(tb.Xt.ext%>% 
             ...
             format.args = list(digits = 3, 
                                format = "G", 
                                flag = "0"),
              caption = "Table 3: Summary statistics for external precision of single ions.") 
```
...
knitr::kable(head(tb.R.ext %>% 
             ...
             format.args = list(digits = 3, 
                                format = "G", 
                                flag = "0"),
              caption = "Table 4: Summary statistics for external precision of isotope ratios.") 
```
